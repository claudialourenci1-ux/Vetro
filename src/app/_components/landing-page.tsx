...
export function LandingPage() {
  return <main className="landing-page">
    ...
    <section className="landing-hero" aria-labelledby="landing-title">
      <div className="landing-hero-copy"><p className="eyebrow">Inteligência comercial para incorporadoras</p><h1 id="landing-title">Clareza para decidir. Controle para crescer.</h1><p>VETRO organiza a operação comercial imobiliária em uma visão precisa: parceiros, pipeline, desempenho e governança no mesmo ambiente.</p><div className="landing-actions"><Link href="/login" className="button button-primary">Acessar a VETRO <ArrowUpRight size={16} /></Link><a href="#inteligencia" className="button button-ghost">Conhecer a plataforma</a></div></div>
      <div className="landing-signal" aria-label="Visão da operação VETRO"><div className="landing-signal-top"><span>OPERAÇÃO COMERCIAL</span><b>Visão integrada</b></div><div className="landing-signal-lines"><i /><i /><i /><i /><i /></div><div className="landing-signal-footer"><span>Dados reais. Decisões melhores.</span><span className="signal-status"><i /> Ativo</span></div></div>
    </section>
